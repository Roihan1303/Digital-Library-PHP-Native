                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    if ($data['status'] == 'Sudah Kembali') { ?>
                                        <td>
                                            <button type="submit" class="badge bg-success-light text-dark">Sudah Kembali</button>
                                            <a href="detailPeminjaman.php?kode=<?= $data['kode_pinjam'] ?>"><button type="submit" class="badge bg-info-light text-dark">Detail</button></a>
                                        </td>
                                    <?php
                                    }
                                    ?>
